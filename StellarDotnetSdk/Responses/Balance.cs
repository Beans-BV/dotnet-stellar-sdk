...
public class Balance
{
    ...
    public Balance(string assetType, string? assetCode, string? assetIssuer, string balance, string limit,
        string? buyingLiabilities, string? sellingLiabilities, bool isAuthorized,
        ...
        string? liquidityPoolId)
    {
        ...
        if (assetType != LiquidityPoolSharesAssetType)
        {
            BuyingLiabilities = buyingLiabilities ??
                                throw new ArgumentNullException(nameof(buyingLiabilities),
                                    "buyingLiabilities cannot be null");
            SellingLiabilities = sellingLiabilities ??
                                 throw new ArgumentNullException(nameof(sellingLiabilities),
                                     "sellingLiabilities cannot be null");
        }
