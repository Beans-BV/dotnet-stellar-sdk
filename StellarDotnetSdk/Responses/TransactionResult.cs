...
using InnerTransactionResultPair = StellarDotnetSdk.Transactions.InnerTransactionResultPair;
using OperationResult = StellarDotnetSdk.Responses.Results.OperationResult;

namespace StellarDotnetSdk.Responses;

using OperationResult = OperationResult;
