...
public class SetOptionsOperationResponse : OperationResponse
{
    ...
    /// </param>
    public SetOptionsOperationResponse(int lowThreshold, int medThreshold, int highThreshold,
        string inflationDestination,
        string homeDomain, string signerKey, int signerWeight, int masterKeyWeight, string[] clearFlags,
        string[] setFlags)
    {
    ...
    public int SignerWeight { get; private set; }

    /// <summary>
    ///     Weight of the master key.
    /// </summary>
    [JsonProperty(PropertyName = "master_key_weight")]
    public int MasterKeyWeight { get; private set; }
