...
{
    /// <summary>
    /// Verifies that PathStrictSendRequestBuilder.BuildUri correctly constructs URI with source amount, source asset, destination account, and destination assets.
    /// </summary>
    /// <remarks>
