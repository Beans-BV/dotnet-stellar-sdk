    ...
    public void TestForReserves()
    {
        using (var server = new Server("https://horizon-testnet.stellar.org"))
        {
            var uri = server.LiquidityPools
                ...
                .BuildUri();
            Assert.AreEqual(
                "https://horizon-testnet.stellar.org/liquidity_pools?reserves=EURTH%3aGAP5LETOV6YIE62YAM56STDANPRDO7ZFDBGSNHJQIYGGKSMOZAHOOS2S,PHP:GAP5LETOV6YIE62YAM56STDANPRDO7ZFDBGSNHJQIYGGKSMOZAHOOS2S",
                uri.ToString());
        }
    }
