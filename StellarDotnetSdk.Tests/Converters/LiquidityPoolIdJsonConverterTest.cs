...
namespace StellarDotnetSdk.Tests.Converters;
    ...
    /// </summary>
    [TestMethod]
    public void TestRead_ValidHexString()
    {
        var result = JsonSerializer.Deserialize<LiquidityPoolId>(@"""4f7f29db33ead1a38c2edf17aa0416c369c207ca081de5c686c050c1ad320385""", _options);
    ...
    public void TestRead_ThrowsForInvalidTokenType()
    {
        // Tests that non-string tokens throw (number, object, array all hit same code path)
        JsonSerializer.Deserialize<LiquidityPoolId>("123", _options);
    }
}
