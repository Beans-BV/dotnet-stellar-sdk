...
namespace StellarDotnetSdk.Tests.Converters;
    ...
    public class SendTransactionStatusEnumJsonConverterTest
    {
        ...
        public void TestRoundTrip_AllStatuses(string jsonValue, SendTransactionResponse.SendTransactionStatus expected)
    {
        // Read
        var deserialized = JsonSerializer.Deserialize<SendTransactionResponse.SendTransactionStatus>($"\"{jsonValue}\"", _options);
    ...
    public void TestRead_ThrowsForUnknownValue()
    {
        JsonSerializer.Deserialize<SendTransactionResponse.SendTransactionStatus>("\"UNKNOWN\"", _options);
    }
}
