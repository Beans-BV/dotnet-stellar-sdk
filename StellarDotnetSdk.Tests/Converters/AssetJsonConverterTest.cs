...
public class AssetJsonConverterTest
{
    ...
    /// </summary>
    [TestMethod]
    public void TestWrite_NativeAsset()
    {
    ...
    /// </summary>
    [TestMethod]
    public void TestWrite_CreditAlphaNum4()
    {
    ...
    /// </summary>
    [TestMethod]
    public void TestWrite_CreditAlphaNum12()
    {
        var issuer = KeyPair.Random();
    ...
    /// </summary>
    [TestMethod]
    public void TestRead_NativeAsset()
    {
    ...
    ///     Verifies that JSON with credit_alphanum4 asset_type deserializes to AssetTypeCreditAlphaNum4 with correct code and issuer.
    /// </summary>
    [TestMethod]
    public void TestRead_CreditAlphaNum4()
    {
        var issuer = KeyPair.Random();
        var json = $@"{{""asset_type"":""credit_alphanum4"",""asset_code"":""USD"",""asset_issuer"":""{issuer.AccountId}""}}";
        var asset = JsonSerializer.Deserialize<Asset>(json, _options);
        Assert.IsNotNull(asset);
    ...
    ///     Verifies that JSON with credit_alphanum12 asset_type deserializes to AssetTypeCreditAlphaNum12 with correct code and issuer.
    /// </summary>
    [TestMethod]
    public void TestRead_CreditAlphaNum12()
    {
        var issuer = KeyPair.Random();
        var json = $@"{{""asset_type"":""credit_alphanum12"",""asset_code"":""TESTTEST"",""asset_issuer"":""{issuer.AccountId}""}}";
        var asset = JsonSerializer.Deserialize<Asset>(json, _options);
        Assert.IsNotNull(asset);
    ...
    public void TestRead_MissingAssetType()
    {
        var json = @"{""asset_code"":""USD"",""asset_issuer"":""GDW6AUTBXTOC7FIKUO5BOO3OGLK4SF7ZPOBLMQHMZDI45J2Z6VXRB5NR""}";
    ...
    [TestMethod]
    [ExpectedException(typeof(ArgumentException))]
    public void TestRead_NonNativeMissingCode()
    {
        var json = @"{""asset_type"":""credit_alphanum4"",""asset_issuer"":""GDW6AUTBXTOC7FIKUO5BOO3OGLK4SF7ZPOBLMQHMZDI45J2Z6VXRB5NR""}";
        JsonSerializer.Deserialize<Asset>(json, _options);
    }
    ...
    [TestMethod]
    [ExpectedException(typeof(ArgumentException))]
    public void TestRead_NonNativeMissingIssuer()
    {
    ...
    public void TestRead_NonObject()
    {
    ...
    /// </summary>
    [TestMethod]
    public void TestRoundTrip_NativeAsset()
    {
    ...
    /// </summary>
    [TestMethod]
    public void TestRoundTrip_CreditAlphaNum4()
    {
        var issuer = KeyPair.Random();
    ...
    /// </summary>
    [TestMethod]
    public void TestRoundTrip_CreditAlphaNum12()
    {
        var issuer = KeyPair.Random();
