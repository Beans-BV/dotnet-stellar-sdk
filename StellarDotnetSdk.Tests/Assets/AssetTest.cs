...
public class AssetTest
{
    ...
    /// Verifies that assets with the same code and issuer are equal, and assets with different codes or issuers are not equal.
    ...
    /// <summary>
    /// Tests that AssetTypeCreditAlphaNum4 constructor throws AssetCodeLengthInvalidException for codes exceeding 4 characters.
    ...
    /// <summary>
    /// Tests that AssetTypeCreditAlphaNum12 constructor throws AssetCodeLengthInvalidException for codes shorter than 5 characters.
    ...
    /// <summary>
    /// Tests that AssetTypeCreditAlphaNum12 constructor throws AssetCodeLengthInvalidException for codes exceeding 12 characters.
    ...
    /// Verifies that CreditAlphaNum4 assets sort before CreditAlphaNum12 assets (4-character codes before 5-12 character codes).
    /// </summary>
    [TestMethod]
