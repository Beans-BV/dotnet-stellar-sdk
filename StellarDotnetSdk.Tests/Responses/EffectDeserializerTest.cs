...
public class EffectDeserializerTest
{
    ...
    private static void AssertAccountCreditedData(EffectResponse instance)
    {
        ...
        var back = new AccountCreditedEffectResponse(effect.Amount, effect.AssetType, effect.AssetCode,
            effect.AssetIssuer);
        Assert.IsNotNull(back);
    }
    ...
    private static void AssertAccountDebitedData(EffectResponse instance)
    {
        ...
        var back = new AccountDebitedEffectResponse(effect.Amount, effect.AssetType, effect.AssetCode,
            effect.AssetIssuer);
        Assert.IsNotNull(back);
    }
    ...
    private static void AssertAccountThresholdsUpdatedData(EffectResponse instance)
    {
        ...
        var back = new AccountThresholdsUpdatedEffectResponse(effect.LowThreshold, effect.MedThreshold,
            effect.HighThreshold);
        Assert.IsNotNull(back);
    }
    ...
    private static void AssertTrustlineRemovedData(EffectResponse instance)
    {
        ...
        var back = new TrustlineRemovedEffectResponse(effect.Limit, effect.AssetType, effect.AssetCode,
            effect.AssetIssuer);
        Assert.IsNotNull(back);
    }
    ...
    private static void AssertTrustlineUpdatedData(EffectResponse instance)
    {
        ...
        var back = new TrustlineUpdatedEffectResponse(effect.Limit, effect.AssetType, effect.AssetCode,
            effect.AssetIssuer);
        Assert.IsNotNull(back);
    }
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/trustline",
            "trustlineAuthorizedToMaintainLiabilities.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
    ...
    private static void AssertTrustlineAuthorizedToMaintainLiabilitiesEffect(EffectResponse instance)
    {
        ...
        var trustline = new TrustlineAuthorizationResponse("GB3E4AB4VWXJDUVN4Z3CPBU5HTMWVEQXONZYVDFMHQD6333KHCOL3UBR",
            "credit_alphanum12", "TESTTEST");
        ...
        var back = new TrustlineAuthorizedToMaintainLiabilitiesEffectResponse(effect.Trustor, effect.AssetType,
            effect.AssetCode);
        Assert.IsNotNull(back);
    }
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/accountSponsorship",
            "accountSponsorshipCreated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/accountSponsorship",
            "accountSponsorshipRemoved.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/accountSponsorship",
            "accountSponsorshipUpdated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/claimableBalance",
            "claimableBalanceClaimantCreated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    private static void AssertClaimableBalanceClaimantCreatedEffect(EffectResponse instance)
    {
        ...
        var back = new ClaimableBalanceClaimantCreatedEffectResponse(effect.Asset, effect.BalanceID, effect.Amount,
            effect.Predicate);
        Assert.IsNotNull(back);
    }
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/claimableBalance",
            "claimableBalanceSponsorshipCreated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/claimableBalance",
            "claimableBalanceSponsorshipRemoved.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/claimableBalance",
            "claimableBalanceSponsorshipUpdated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    private static void AssertClaimableBalanceSponsorshipUpdatedEffect(EffectResponse instance)
    {
        ...
        var back = new ClaimableBalanceSponsorshipUpdatedEffectResponse(effect.BalanceID, effect.FormerSponsor,
            effect.NewSponsor);
        Assert.IsNotNull(back);
    }
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/signerSponsorship",
            "signerSponsorshipCreated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/trustlineSponsorship",
            "trustlineSponsorshipCreated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/trustlineSponsorship",
            "trustlineSponsorshipRemoved.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    {
        var json = File.ReadAllText(Path.Combine("testdata/effects/trustlineSponsorship",
            "trustlineSponsorshipUpdated.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
    ...
    private static void AssertTrustlineFlagsUpdatedEffect(EffectResponse instance)
    {
        ...
        var back = new TrustlineFlagsUpdatedEffectResponse(effect.AssetType, effect.AssetCode, effect.AssetIssuer,
            effect.Trustor, effect.AuthorizedFlag, effect.AuthorizedToMaintainLiabilities, effect.ClawbackEnabledFlag);
        Assert.IsNotNull(back);
    }
    ...
    public void TestSerializationClaimableBalanceClawedBackEffect()
    {
        var json = File.ReadAllText(
            Path.Combine("testdata/effects/claimableBalance", "claimableBalanceClawedBack.json"));
        var instance = JsonSingleton.GetInstance<EffectResponse>(json);
        var serialized = JsonConvert.SerializeObject(instance);
        var back = JsonConvert.DeserializeObject<EffectResponse>(serialized);
        Assert.IsNotNull(back);
