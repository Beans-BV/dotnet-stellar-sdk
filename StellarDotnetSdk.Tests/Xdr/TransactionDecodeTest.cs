...
using Transaction = StellarDotnetSdk.Xdr.Transaction;
using TransactionMeta = StellarDotnetSdk.Xdr.TransactionMeta;
...
public class TransactionDecodeTest
{
    ...
    {
        const string noTailTransactionXdr =
        ...
        Assert.IsNotNull(decodedTransaction.Memo);
    ...
    {
        const string transactionEnvelopeToDecode =
