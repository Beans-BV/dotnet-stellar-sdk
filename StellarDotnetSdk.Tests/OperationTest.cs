...
using ClaimPredicate = StellarDotnetSdk.Claimant.ClaimPredicate;
...
public class OperationTest
{
    ...
    public void TestChangeTrustOperation()
    {
        ...
        var asset = ChangeTrustAsset.Create(new AssetTypeNative());
    ...
    public void TestCreateClaimableBalanceOperation()
    {
        ...
        var claimant = new Claimant.Claimant(destination, ClaimPredicate.Not(ClaimPredicate.BeforeRelativeTime(
    ...
    {
        var operation =
            new RevokeLedgerEntrySponsorshipOperation.Builder(
                "c8789370cda62cdb5be83642f5af61829c0c77afde7d0fb7577a8f320467563f").Build();
    ...
    public void TestClawbackClaimableBalanceOperation()
    {
        ...
        var operation =
            new ClawbackClaimableBalanceOperation.Builder(
                    "00000000526674017c3cf392614b3f2f500230affd58c7c364625c350c61058fbeacbdf7")
                .SetSourceAccount(source)
                .Build();
    ...
    public void TestSetTrustlineFlagsOperation()
    {
        ...
        var operation = new SetTrustlineFlagsOperation.Builder(
                Asset.CreateNonNativeAsset("EUR", "GDIROJW2YHMSFZJJ4R5XWWNUVND5I45YEWS5DSFKXCHMADZ5V374U2LM"),
                KeyPair.Random(), 1, 1)
            .SetSourceAccount(source)
            .Build();
