...
public class KeyPairBip39Tests
{
    ...
    public void FromBIP39Seed_WithLargeAccountIndices_DerivesCorrectAccounts()
    {
        ...
        // Act & Assert
        Bip39Assert.AssertDerivedAccount(bip39Seed, 255,
            "GCTRTUTKLQH6FDTYKPJRHJ6WDWWFDSLHAGACOHO24EOLBAH6C5FV7A42",
            "SC2FHENKO4ZVTE5FHJFCUHVYXPEX5ZAK5CD22RNDGX7U4FKEN7GILR2L");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 256,
            "GDQPW7IEO2JJFDYZIWHAAURS4LVEVJLS32ORNDT5C65VX4QBBZDBXMTK",
            "SA22OBLJSYNDSI6Q7U7MWAZS46VSOLZIZBEMFGIRJQLN7T52ALHRBY76");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 65535,
            "GA5C44SIX3OT26KRWEMSDQ6WUYM7X2S3FBCSVQFVXFAPDEZVE52XGGZ5",
            "SCBKC5IYD2QOBDOJBBCS35AL4BCFUAZ4TUKMMQWRWQO6DF5NMMCHUNWT");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 65536,
            "GA3UR4B2UTDK43NVWN2CRGY3UK3SBXW43Z6JEOFFN6RCWKLJ4MVU6SBG",
            "SDEYL3NP4FTV6CMZQG4LLJDOG6K3JGU43KRMEWEUQJYNAGHL4TMJ3CPY");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 16777215,
            "GCVG47JM5NZT6QGT54XDSH3N2JQ6BGROZLV4OEPUVSX5Y73EXCWTELFA",
            "SDMCLW2644HORS5AXBNBTWK5UPFJ6OGPZNNONVU67SFG3BTYZZ5QGJ7N");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 16777216,
            "GDCOX23B54OWNO5QS7DRMHUVOPQSCUYBPL6FUA3XN4QXFQG5VFMQ2CLC",
            "SAOGZUMN6H3KU5I6VAE75DQZMZID4BQB54ODWBIYSBETBWTF4AMQPNV2");
        Bip39Assert.AssertDerivedAccount(bip39Seed, 2147483647,
            "GDFBFRFJ32FAS747QDP3IQBL4JQHJNSVPUYDD2VL74GY7XIPFPX4CNS4",
            "SASBZQXVQJCOIVGW5NHMFJZ7ZDASQAIG6EYNMJWOEKAUSVKEI4LKUDDW");
    }
    ...
    private static class Bip39Assert
    {
        ...
        /// <param name="expectedAccountId">The expected account ID.</param>
        /// <param name="expectedSecret">The expected secret seed.</param>
        public static void AssertDerivedAccount(string bip39Seed, uint accountIndex, string expectedAccountId,
            string expectedSecret)
        {
            // Act - Test with string seed
            var pair1 = KeyPair.FromBIP39Seed(bip39Seed, accountIndex);

            // Assert - Verify string seed derivation
