...
public class TransactionHistoryResultEntry
{
    ...
    {
        if (maxDepth <= 0)
            throw new InvalidDataException("Maximum decoding depth reached while decoding TransactionHistoryResultEntry");
        maxDepth -= 1;
    ...
    public class TransactionHistoryResultEntryExt
    {
        ...
        public static void Encode(XdrDataOutputStream stream, TransactionHistoryResultEntryExt encodedTransactionHistoryResultEntryExt)
        {
            ...
            switch (encodedTransactionHistoryResultEntryExt.Discriminant)
            {
                case 0:
                    break;
                default:
                    throw new InvalidDataException("Unknown discriminant value: " + encodedTransactionHistoryResultEntryExt.Discriminant);
            }
        }
        ...
        {
            if (maxDepth <= 0)
                throw new InvalidDataException("Maximum decoding depth reached while decoding TransactionHistoryResultEntryExt");
            maxDepth -= 1;
