...
public class SorobanTransactionMetaExtV1
{
    ...
    public static void Encode(XdrDataOutputStream stream, SorobanTransactionMetaExtV1 encodedSorobanTransactionMetaExtV1)
    {
    ...
    {
        if (maxDepth <= 0)
            throw new InvalidDataException("Maximum decoding depth reached while decoding SorobanTransactionMetaExtV1");
        maxDepth -= 1;
        ...
        decodedSorobanTransactionMetaExtV1.TotalNonRefundableResourceFeeCharged = Int64.Decode(stream, maxDepth);
        decodedSorobanTransactionMetaExtV1.TotalRefundableResourceFeeCharged = Int64.Decode(stream, maxDepth);
