...
public class Operation
{
    ...
    public class OperationBody
    {
        ...
        public static void Encode(XdrDataOutputStream stream, OperationBody encodedOperationBody)
        {
            ...
            switch (encodedOperationBody.Discriminant.InnerValue)
            {
                ...
                case OperationType.OperationTypeEnum.RESTORE_FOOTPRINT:
                    ...
                    break;
                default:
                    throw new InvalidDataException("Unknown discriminant value: " + encodedOperationBody.Discriminant.InnerValue);
            }
        }
        ...
        {
            if (maxDepth <= 0)
                throw new InvalidDataException("Maximum decoding depth reached while decoding OperationBody");
            maxDepth -= 1;
            ...
            switch (decodedOperationBody.Discriminant.InnerValue)
            {
                ...
                case OperationType.OperationTypeEnum.PAYMENT:
                    ...
                    break;
                case OperationType.OperationTypeEnum.PATH_PAYMENT_STRICT_RECEIVE:
                    decodedOperationBody.PathPaymentStrictReceiveOp = PathPaymentStrictReceiveOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.MANAGE_SELL_OFFER:
                    decodedOperationBody.ManageSellOfferOp = ManageSellOfferOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.CREATE_PASSIVE_SELL_OFFER:
                    decodedOperationBody.CreatePassiveSellOfferOp = CreatePassiveSellOfferOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.SET_OPTIONS:
                ...
                case OperationType.OperationTypeEnum.MANAGE_BUY_OFFER:
                    ...
                    break;
                case OperationType.OperationTypeEnum.PATH_PAYMENT_STRICT_SEND:
                    decodedOperationBody.PathPaymentStrictSendOp = PathPaymentStrictSendOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.CREATE_CLAIMABLE_BALANCE:
                    decodedOperationBody.CreateClaimableBalanceOp = CreateClaimableBalanceOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.CLAIM_CLAIMABLE_BALANCE:
                    decodedOperationBody.ClaimClaimableBalanceOp = ClaimClaimableBalanceOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.BEGIN_SPONSORING_FUTURE_RESERVES:
                    decodedOperationBody.BeginSponsoringFutureReservesOp = BeginSponsoringFutureReservesOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.END_SPONSORING_FUTURE_RESERVES:
                    break;
                case OperationType.OperationTypeEnum.REVOKE_SPONSORSHIP:
                ...
                case OperationType.OperationTypeEnum.CLAWBACK:
                    ...
                    break;
                case OperationType.OperationTypeEnum.CLAWBACK_CLAIMABLE_BALANCE:
                    decodedOperationBody.ClawbackClaimableBalanceOp = ClawbackClaimableBalanceOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.SET_TRUST_LINE_FLAGS:
                    decodedOperationBody.SetTrustLineFlagsOp = SetTrustLineFlagsOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.LIQUIDITY_POOL_DEPOSIT:
                    decodedOperationBody.LiquidityPoolDepositOp = LiquidityPoolDepositOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.LIQUIDITY_POOL_WITHDRAW:
                    decodedOperationBody.LiquidityPoolWithdrawOp = LiquidityPoolWithdrawOp.Decode(stream, maxDepth);
                    break;
                case OperationType.OperationTypeEnum.INVOKE_HOST_FUNCTION:
