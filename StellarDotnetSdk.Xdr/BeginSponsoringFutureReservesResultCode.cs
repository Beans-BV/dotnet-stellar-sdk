...
public class BeginSponsoringFutureReservesResultCode
{
    ...
    public static BeginSponsoringFutureReservesResultCode Decode(XdrDataInputStream stream)
    {
        ...
        switch (value)
        {
            ...
            case -1:
                return Create(BeginSponsoringFutureReservesResultCodeEnum.BEGIN_SPONSORING_FUTURE_RESERVES_MALFORMED);
            case -2:
                return Create(BeginSponsoringFutureReservesResultCodeEnum
                    .BEGIN_SPONSORING_FUTURE_RESERVES_ALREADY_SPONSORED);
            case -3:
                return Create(BeginSponsoringFutureReservesResultCodeEnum.BEGIN_SPONSORING_FUTURE_RESERVES_RECURSIVE);
            default:
