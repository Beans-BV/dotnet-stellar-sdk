...
{
    public PathPaymentStrictSendResultCode Discriminant { get; set; } = new();
    ...
    public static void Encode(XdrDataOutputStream stream, PathPaymentStrictSendResult encodedPathPaymentStrictSendResult)
    {
        ...
        switch (encodedPathPaymentStrictSendResult.Discriminant.InnerValue)
        {
            ...
            case PathPaymentStrictSendResultCode.PathPaymentStrictSendResultCodeEnum.PATH_PAYMENT_STRICT_SEND_UNDER_DESTMIN:
                break;
            default:
                throw new InvalidDataException("Unknown discriminant value: " + encodedPathPaymentStrictSendResult.Discriminant.InnerValue);
        }
    }
    ...
    {
        if (maxDepth <= 0)
            throw new InvalidDataException("Maximum decoding depth reached while decoding PathPaymentStrictSendResult");
        maxDepth -= 1;
        var decodedPathPaymentStrictSendResult = new PathPaymentStrictSendResult();
        var discriminant = PathPaymentStrictSendResultCode.Decode(stream, maxDepth);
        ...
        {
            case PathPaymentStrictSendResultCode.PathPaymentStrictSendResultCodeEnum.PATH_PAYMENT_STRICT_SEND_SUCCESS:
                decodedPathPaymentStrictSendResult.Success = PathPaymentStrictSendResultSuccess.Decode(stream, maxDepth);
                break;
            case PathPaymentStrictSendResultCode.PathPaymentStrictSendResultCodeEnum.PATH_PAYMENT_STRICT_SEND_MALFORMED:
            case PathPaymentStrictSendResultCode.PathPaymentStrictSendResultCodeEnum.PATH_PAYMENT_STRICT_SEND_UNDERFUNDED:
            case PathPaymentStrictSendResultCode.PathPaymentStrictSendResultCodeEnum.PATH_PAYMENT_STRICT_SEND_SRC_NO_TRUST:
