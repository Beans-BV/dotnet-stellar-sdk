...
public class SorobanAuthorizedFunction
{
    ...
    public static void Encode(XdrDataOutputStream stream, SorobanAuthorizedFunction encodedSorobanAuthorizedFunction)
    {
        ...
        {
            case SorobanAuthorizedFunctionType.SorobanAuthorizedFunctionTypeEnum.SOROBAN_AUTHORIZED_FUNCTION_TYPE_CONTRACT_FN:
                InvokeContractArgs.Encode(stream, encodedSorobanAuthorizedFunction.ContractFn);
                break;
            case SorobanAuthorizedFunctionType.SorobanAuthorizedFunctionTypeEnum.SOROBAN_AUTHORIZED_FUNCTION_TYPE_CREATE_CONTRACT_HOST_FN:
    ...
    public static SorobanAuthorizedFunction Decode(XdrDataInputStream stream, int maxDepth)
    {
        ...
        switch (decodedSorobanAuthorizedFunction.Discriminant.InnerValue)
        {
            case SorobanAuthorizedFunctionType.SorobanAuthorizedFunctionTypeEnum.SOROBAN_AUTHORIZED_FUNCTION_TYPE_CONTRACT_FN:
                ...
                break;
            case SorobanAuthorizedFunctionType.SorobanAuthorizedFunctionTypeEnum.SOROBAN_AUTHORIZED_FUNCTION_TYPE_CREATE_CONTRACT_HOST_FN:
                decodedSorobanAuthorizedFunction.CreateContractHostFn = CreateContractArgs.Decode(stream, maxDepth);
                break;
            case SorobanAuthorizedFunctionType.SorobanAuthorizedFunctionTypeEnum.SOROBAN_AUTHORIZED_FUNCTION_TYPE_CREATE_CONTRACT_V2_HOST_FN:
