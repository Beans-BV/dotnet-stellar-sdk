...
public class ConfigSettingContractLedgerCostV0
{
    ...
    public static void Encode(XdrDataOutputStream stream, ConfigSettingContractLedgerCostV0 encodedConfigSettingContractLedgerCostV0)
    {
    ...
    {
        if (maxDepth <= 0)
            throw new InvalidDataException("Maximum decoding depth reached while decoding ConfigSettingContractLedgerCostV0");
        maxDepth -= 1;
        ...
        decodedConfigSettingContractLedgerCostV0.LedgerMaxDiskReadBytes = Uint32.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.LedgerMaxWriteLedgerEntries = Uint32.Decode(stream, maxDepth);
        ...
        decodedConfigSettingContractLedgerCostV0.TxMaxWriteLedgerEntries = Uint32.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.TxMaxWriteBytes = Uint32.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.FeeDiskReadLedgerEntry = Int64.Decode(stream, maxDepth);
        ...
        decodedConfigSettingContractLedgerCostV0.SorobanStateTargetSizeBytes = Int64.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.RentFee1KBSorobanStateSizeLow = Int64.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.RentFee1KBSorobanStateSizeHigh = Int64.Decode(stream, maxDepth);
        decodedConfigSettingContractLedgerCostV0.SorobanStateRentFeeGrowthFactor = Uint32.Decode(stream, maxDepth);
