...
{
    public LiquidityPool(LiquidityPoolID id, int feeBP, LiquidityPoolType.LiquidityPoolTypeEnum type,
        int totalTrustlines, string totalShares, AssetAmount[] reserves)
    {
        ID = id;
        FeeBP = feeBP;
        Type = type;
