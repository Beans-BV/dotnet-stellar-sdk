...
public class PathPaymentStrictReceiveOperationResponse : OperationResponse
{
    ...
    /// <summary>
    ///     Sends an amount in a specific asset to a destination account through a path of offers. This allows the asset sent
    ///     (e.g., 450 XLM) to be different from the asset received (e.g, 6 BTC).
    /// </summary>
    ...
    public PathPaymentStrictReceiveOperationResponse(string from, string to, string assetType, string assetCode,
        string assetIssuer, string amount, string sourceAssetType, string sourceAssetCode,
