...
public class CreateAccountOperation : Operation
{
    ...
    ///     Amount in XLM the account should be funded for. Must be greater than the
    ///     <see href="https://www.stellar.org/developers/guides/concepts/fees.html">reserve balance amount.</see>
    /// </param>
