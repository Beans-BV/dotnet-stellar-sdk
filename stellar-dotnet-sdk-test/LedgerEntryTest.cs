...
using AccountEntryExtensionV1 = stellar_dotnet_sdk.xdr.AccountEntryExtensionV1;
using AccountEntryExtensionV2 = stellar_dotnet_sdk.xdr.AccountEntryExtensionV2;
using AccountEntryExtensionV3 = stellar_dotnet_sdk.xdr.AccountEntryExtensionV3;
using Asset = stellar_dotnet_sdk.Asset;
using ClaimableBalanceEntryExtensionV1 = stellar_dotnet_sdk.xdr.ClaimableBalanceEntryExtensionV1;
using Claimant = stellar_dotnet_sdk.xdr.Claimant;
...
using Liabilities = stellar_dotnet_sdk.xdr.Liabilities;
using LiquidityPoolConstantProductParameters = stellar_dotnet_sdk.xdr.LiquidityPoolConstantProductParameters;
using Price = stellar_dotnet_sdk.xdr.Price;
using SCAddress = stellar_dotnet_sdk.xdr.SCAddress;
using SCString = stellar_dotnet_sdk.SCString;
using SCVal = stellar_dotnet_sdk.xdr.SCVal;
using Signer = stellar_dotnet_sdk.xdr.Signer;
using StateArchivalSettings = stellar_dotnet_sdk.StateArchivalSettings;
using String64 = stellar_dotnet_sdk.xdr.String64;
using TrustLineEntryExtensionV2 = stellar_dotnet_sdk.xdr.TrustLineEntryExtensionV2;
...
public class LedgerEntryTest
{
    ...
    private stellar_dotnet_sdk.xdr.LedgerEntry.LedgerEntryData InitBasicAccountEntry()
    {
        var accountEntry = new AccountEntry
        {
            ...
            Thresholds = new Thresholds(new byte[] { 1, 2, 3, 0 }),
            Signers = new Signer[]
            {
            },
        ...
        return new stellar_dotnet_sdk.xdr.LedgerEntry.LedgerEntryData
        {
    ...
    private ContractDataEntry InitBasicContractDataEntry()
    {
        return new ContractDataEntry
        {
            ...
            Key = new SCVal
            {
                ...
                Str = new stellar_dotnet_sdk.xdr.SCString("key 1")
            },
            Durability =
    ...
    public void TestLedgerEntryAccountWithTooLongHomeDomain()
    {
        ...
        stellar_dotnet_sdk.xdr.LedgerEntry.LedgerEntryData.Encode(os, xdrLedgerEntry);
    ...
    public void TestLedgerEntryAccountWithAccountExtensionV1AndV2()
    {
        ...
        for (var i = 0; i < xdrExtensionV2.SignerSponsoringIDs.Length; i++)
            CollectionAssert.AreEqual(xdrExtensionV2.SignerSponsoringIDs[i].InnerValue.InnerValue.Ed25519.InnerValue,
                decodedExtensionV2.SignerSponsoringIDs[i].XdrPublicKey.Ed25519.InnerValue);
        // V3
    ...
    public void TestLedgerEntryOfferWithAllPropertiesPopulated()
    {
        ...
        var os = new XdrDataOutputStream();
        stellar_dotnet_sdk.xdr.LedgerEntry.LedgerEntryData.Encode(os, xdrLedgerEntryData);
        var entryXdrBase64 = Convert.ToBase64String(os.ToArray());
        // Act
    ...
    {
        var xdrConfigSetting = new stellar_dotnet_sdk.xdr.StateArchivalSettings
        {
    ...
    {
        var xdrConfigSetting = new stellar_dotnet_sdk.xdr.EvictionIterator
        {
